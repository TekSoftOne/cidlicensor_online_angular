  ...
  window.initAutocomplete = function () {
    try {
      ...
      var GoogleMap = new google.maps.Map(
        document.getElementById("map_with_google_api"),
        {
      ...
      $(document).on("click keydown", "#meta_data_container", function (event) {
        ...
        if (
          ...
          (event.keyCode =
            "undefined" &&
            (GoToCoordsButton.is(event.target) ||
              !(GoToCoordsButton.has(event.target).length === 0)))
        ) {
      ...
      GoogleMap.data.setStyle(function (feature) {
        ...
        var strokeWeight = 6;
        if (
          feature.getProperty("isColorful") == true ||
          feature.getProperty("isColorful") == undefined
        ) {
      ...
      GoogleMap.data.addListener("click", function (event) {
        ...
        if (
          event.feature.getProperty("isColorful") != true &&
          event.feature.getProperty("isColorful") != undefined
        ) {
      ...
      GoogleMap.data.addListener("mousemove", function (event) {
        ...
        if (event.feature.getProperty("surface") != undefined) {
          lineOptionsText =
            lineOptionsText +
            "Surface: " +
            event.feature.getProperty("surface") +
            "</br>";
        }
        if (event.feature.getProperty("width") != undefined) {
          lineOptionsText =
            lineOptionsText +
            "Width: " +
            event.feature.getProperty("width") +
            "m</br>";
        }
        if (event.feature.getProperty("populousness") != undefined) {
          lineOptionsText =
            lineOptionsText +
            "Populousness: " +
            event.feature.getProperty("populousness") +
            "</br>";
        }
        if (event.feature.getProperty("quality") != undefined) {
          lineOptionsText =
            lineOptionsText +
            "Quality: " +
            event.feature.getProperty("quality") +
            "</br>";
        }
        if (event.feature.getProperty("rating") != undefined) {
          lineOptionsText =
            lineOptionsText +
            "Rating: " +
            event.feature.getProperty("rating") +
            "</br>";
        }
        if (event.feature.getProperty("color") != undefined) {
          lineOptionsText =
            lineOptionsText +
            "Color: " +
            event.feature.getProperty("color") +
            "</br>";
        }
        if (event.feature.getProperty("descendants") != undefined) {
          lineOptionsText =
            lineOptionsText +
            "Descendants: " +
            event.feature.getProperty("descendants") +
            "</br>";
        }
